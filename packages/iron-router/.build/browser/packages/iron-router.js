...
if (Package.ui) {                                                                                     // 9
  ...
  var processPathArgs = function (routeName, options) {                                               // 16
    ...
    var query = opts.query;                                                                           // 25
                                                                                                      // 26
    // if called without opts, use the data context of the parent                                     // 27
    if (_.isEmpty(opts))                                                                              // 28
      params = getData(this);                                                                         // 29
                                                                                                      // 30
    return {                                                                                          // 31
      routeName: routeName,                                                                           // 32
      params: params,                                                                                 // 33
      query: query,                                                                                   // 34
      hash: hash                                                                                      // 35
    };                                                                                                // 36
                                                                                                      ...
                                                                                                      // 38
  _.extend(Router.helpers, {                                                                          // 39
                                                                                                      // 40
    /**                                                                                               // 41
     * Example Use:                                                                                   // 42
     *                                                                                                // 43
     *  {{pathFor 'items' params=this}}                                                               // 44
     *  {{pathFor 'items' id=5 query="view=all" hash="somehash"}}                                     // 45
     *  {{pathFor route='items' id=5 query="view=all" hash="somehash"}}                               // 46
     */                                                                                               // 47
                                                                                                      // 48
    pathFor: function (routeName, options) {                                                          // 49
      var args = processPathArgs.call(this, routeName, options);                                      // 50
                                                                                                      // 51
      return Router.path(args.routeName, args.params, {                                               // 52
        query: args.query,                                                                            // 53
        hash: args.hash                                                                               // 54
      });                                                                                             // 55
    },                                                                                                // 56
                                                                                                      // 57
    /**                                                                                               // 58
     * Same as pathFor but returns entire aboslute url.                                               // 59
     *                                                                                                // 60
     */                                                                                               // 61
    urlFor: function (routeName, options) {                                                           // 62
      var args = processPathArgs.call(this, routeName, options);                                      // 63
                                                                                                      // 64
      return Router.url(args.routeName, args.params, {                                                // 65
        query: args.query,                                                                            // 66
        hash: args.hash                                                                               // 67
      });                                                                                             // 68
    }                                                                                                 // 69
                                                                                                      ...
                                                                                                      // 71
  _.each(Router.helpers, function (helper, name) {                                                    // 72
    Handlebars.registerHelper(name, helper);                                                          // 73
  });                                                                                                 // 74
}                                                                                                     // 75
                                                                                                      // 76
////////////////////////////////////////////////////////////////////////////////////////////////////////
